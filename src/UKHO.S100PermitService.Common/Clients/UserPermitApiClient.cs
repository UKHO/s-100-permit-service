...
namespace UKHO.S100PermitService.Common.Clients
{
    public class UserPermitApiClient : IUserPermitApiClient
    {
        ...
        /// <returns>Shop Facade - User Permit Service response.</returns>
        public async Task<HttpResponseMessage> GetUserPermitsAsync(string uri, int licenceId, string accessToken, string correlationId, CancellationToken cancellationToken)
        {
