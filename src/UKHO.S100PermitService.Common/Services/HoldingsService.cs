...
namespace UKHO.S100PermitService.Common.Services
{
    public class HoldingsService : IHoldingsService
    {
        ...
        public async Task<(HttpStatusCode httpStatusCode, List<HoldingsServiceResponse>)> GetHoldingsAsync(int licenceId, CancellationToken cancellationToken, string correlationId)
        {
