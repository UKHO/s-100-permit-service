...
namespace UKHO.S100PermitService.Common.UnitTests.IO
{
    ...
    public class SchemaValidatorTests
    {
        ...
        public void WhenSchemaIsInvalid_ThenReturnsFalse()
        {
            ...
            var result = _schemaValidator.ValidateSchema(fakeInvalidPermit, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "XmlSchema", "Permit_Schema.xsd"));
        ...
        public void WhenSchemaIsValid_ThenReturnsTrue()
        {
            ...
            var result = _schemaValidator.ValidateSchema(fakeValidPermit, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "XmlSchema", "Permit_Schema.xsd"));
